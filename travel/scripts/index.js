...
4. Требования к css + 12  ✔
    ...
    ° фоновый цвет тянется на всю ширину страницы +2 ✔ (#E5E5E5 color) 
...
5. Интерактивность, реализуемая через css +20
    ...
    ° обязательное требование к интерактивности: плавное изменение внешнего вида 
      элемента при наведении и клике не влияющее на соседние элементы +5
